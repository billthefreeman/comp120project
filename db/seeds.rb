...
when "production"
	...
	Conversation.create(:sender_id =>1, :recipient_id=>5)
	...
	Conversation.create(:sender_id =>2, :recipient_id=>6)
	...
	Conversation.create(:sender_id =>3, :recipient_id=>5)
	Conversation.create(:sender_id =>3, :recipient_id=>6)
	...
	Conversation.create(:sender_id =>4, :recipient_id=>5)
	Conversation.create(:sender_id =>4, :recipient_id=>6)
	Conversation.create(:sender_id =>5, :recipient_id=>6)
