class AddRow < ActiveRecord::Migration
  def self.up
		...
		Person.create(:last_name => "Ye", :user_name => "Fanying",:group_id => 1,:phone=>"1234567888",:email=>"123@tufts.edu",:pw=>"Yfy.911220")
		Person.create(:last_name => "Huo",:user_name => "Yan",:group_id => 2,:phone=>"2345678999",:email=>"234@tufts.edu",:pw=>"Yfy.911220")
		Person.create(:last_name => "Bu",:user_name => "Min",:group_id => 3,:phone=>"3456789000",:email=>"345@tufts.edu",:pw=>"Yfy.911220")
		Person.create(:last_name => "Lu",:user_name => "Feiyu",:group_id => 4,:phone=>"4567890111",:email=>"456@tufts.edu",:pw=>"Yfy.911220")
